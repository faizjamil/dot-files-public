...
# bash <(curl -sL "https://raw.githubusercontent.com/faizjamil/dot-files-public/main/base_arch_packages_install.sh")
...
pacstrap -K /mnt base base-devel linux linux-firmware intel-ucode nano man-db man-pages git curl networkmanager